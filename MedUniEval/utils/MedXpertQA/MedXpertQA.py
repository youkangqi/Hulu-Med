...
class MedXpertQA(BaseDataset):
    def __init__(self,model,dataset_path,output_path,split = "MM"):
        ...
        self.dataset_path = "/home/data/songtao/MedEvalKit/MedXpertQA"
        self.samples = []
    ...
    def construct_messages(self,sample):
        ...
        delimiter = "Answer Choices:"
        question_only = question.split(delimiter)[0].strip()
        is_reasoning = True if os.environ.get("REASONING","False") == "True" else False
        prompt = get_multiple_choice_prompt(question_only,choices,is_reasoning)
